...
// Description:
// ------------
// Converts an IR remote control to a presenter.
//
// References:
// -----------
...
// - Use your NEC-compatible IR remote as a presenter.
  ...
  while(1) {
    if(IR_available()) {                      // IR signal coming in?
      ...
      switch(command) {                       // send key according to command
        case IR_CMD_NEXT:     KBD_type('n'); break;
        case IR_CMD_PREV:     KBD_type('p'); break;
        case IR_CMD_BLACK:    KBD_type('b'); break;
        case IR_CMD_WHITE:    KBD_type('w'); break;
        case IR_CMD_START:    KBD_type(KBD_KEY_F5);   break;
        case IR_CMD_END:      KBD_type(KBD_KEY_ESC);  break;
        case IR_CMD_VOL_UP:   CON_type(CON_VOL_UP);   break;
        case IR_CMD_VOL_DOWN: CON_type(CON_VOL_DOWN); break;
        case IR_CMD_VOL_MUTE: CON_type(CON_VOL_MUTE); break;
        default:              break;
      }
    }
  }
